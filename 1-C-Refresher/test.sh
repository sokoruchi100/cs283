...
@test "basic string search replace" {
    ...
    [ "$output" = "Modified String: This is a great test
Buffer:  [This is a great test..............................]" ] ||
...
@test "basic overflow search replace" {
    ...
    [ "$output" = "Modified String: This is a super long string for validating my prog
Buffer:  [This is a super long string for validating my prog]" ] ||
    [ "$output" = "Not Implemented!" ]
}
...
@test "test shorter string replace" {
    ...
    [ "$output" = "Modified String: This is a super long string for testing my app
Buffer:  [This is a super long string for testing my app....]" ] || 
    [ "$output" = "Not Implemented!" ]
}